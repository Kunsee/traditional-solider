...
var config = {
        ...
        watcher : {
            ...
            jsRule: [sourcePath+'/*.js', sourcePath+'/**/*.js'],
...
gulp.task('move-file', function () {
    gulp.src([sourcePath+'/libs/**'])
        .pipe(gulp.dest(sourceBuild+'/libs/'))
    gulp.src([sourcePath+'/images/**'])
        .pipe(gulp.dest(sourceBuild+'/images/'))
});
...
gulp.task('server-build', sequence('move','move-file',['html'],['images','scss'],['css'],['js-babel'] ) );
